...
///
/// This function is an async version of [`core::fs::hard_link`].
///
/// [`core::fs::hard_link`]: https://doc.rust-lang.org/core/fs/fn.hard_link.html
///
/// # Errors
///
...
pub async fn hard_link<P: AsRef<Path>, Q: AsRef<Path>>(from: P, to: Q) -> io::Result<()> {
    ...
    spawn_blocking(move || {
        core::fs::hard_link(&from, &to).context(|| {
            format!(
